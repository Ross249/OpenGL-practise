...
int main(void)
{
    ...
    std::cout << glGetString(GL_VERSION) << std::endl;
    {
        ...
        glm::mat4 view = glm::translate(glm::mat4(1.0f), glm::vec3(-1, -1, 0));
        ...
        Texture texture("res/textures/C++_Logo.png");
        texture.Bind();
        ...
        glm::vec3 translationA(1, 1, 0);
        glm::vec3 translationB(1.5, 1.5, 0);
